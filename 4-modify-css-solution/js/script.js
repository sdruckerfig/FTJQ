...
(function($){
	...
	jQuery(document).ready(function () {
		...
		// toggle background when item is clicked
		$(".item").on("click", function() {
			$(this).toggleClass("selected");
			// if any selected item is on sale, display sale message, else hide
			if ($(".item.selected").hasClass("sale")) {
				$("#saleMessage").css("display", "inline");
			} else
			{
				$("#saleMessage").css("display", "none");
			}
		});
