(function($){
	...
	$(document).ready(function() {
		...
		$("#newButton").on("click", function(event){
			...
			// reset arrays and display images
			setNewGame();

			// remove image event handlers
			$("img.product").off("click");

			// assign single-use click handler to each image
			$("img.product").one("click", handleImageClick);
			// $("img.product").one("click mouseover", handleImageClick);
