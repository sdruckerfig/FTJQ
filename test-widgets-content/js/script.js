(function($){ 
	...
	$(document).ready(function() {
		...
		$("#contactdialog").dialog({
			...
			modal: true,
			buttons: [
				{text: "Close", click: function(event){$(this).dialog("close")}},
				{text: "Clear", click: function(event){$("input[name='email']").val("")}}
			]
		});
		...
		$("input[name='reviewdate']").datepicker({dateFormat:"mm-dd-yy"});
